...
{
    m_titleLabel = new QLabel("非对称对抗", this);
    ...
    m_characterBtn = new QPushButton("角色选择", this);
    ...
    for (auto *btn : {m_startBtn, m_characterBtn, m_settingsBtn, m_helpBtn, m_quitBtn})
    ...
    connect(m_characterBtn, &QPushButton::clicked, this, &MainMenuWidget::selectCharacterClicked);
